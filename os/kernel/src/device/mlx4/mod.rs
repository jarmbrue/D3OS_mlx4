...
use rdma::{AccessFlags, DeviceAttr, PortAttr, QueuePairAttr, QueuePairAttrMask, QueuePairType};
...
impl ConnectX3Nic {
    ...
    pub fn create_mr<T>(&mut self, data: &mut [T], access: AccessFlags) -> Result<DataMemoryProtectionTable, &'static str> {
